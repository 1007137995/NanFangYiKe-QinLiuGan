    ...
    IEndDragHandler, IPointerEnterHandler, IPointerExitHandler
{
    ...
    //public RectTransform imgSprite;        //得到图片的ugui坐标
    private Vector3 tar;
    private Vector3 tarF;
    ...
    void Start()
    {
        tar = imgRect.transform.position - new Vector3(138, 0, 0);
        tarF = new Vector3((imgRect.transform.position.x - 138) * 1.96f, imgRect.transform.position.y * 1.96f, imgRect.transform.position.z * 1.96f + 50f);
        //imgSprite = GetComponent<RectTransform>();
        //Debug.Log(imgSprite.anchoredPosition);
    }
    ...
    public void OnPointerDown(PointerEventData eventData)
    {
        ...
        {
            //计算图片中心和鼠标点的差值
            //imgRect.anchoredPosition = imgSprite.anchoredPosition;
    ...
    public void OnPointerUp(PointerEventData eventData)
    {
        ...
        //{
        //    imgRect.transform.position = tarF;
        //}
        //else
        //{
        //    imgRect.transform.position = tar;
        //}
        imgRect.transform.position = transform.position;
        offset = Vector2.zero;
        Model();
    }
    ...
    public void Model()
    {
        ...
        {
            if (hitInfo.collider.tag == "Model")
            {
                MovieManager.instance.chuanyifu(transform.parent.gameObject);
            }
        }
    }
}
